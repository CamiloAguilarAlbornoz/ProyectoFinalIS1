...
<html>
	...
	<body>
		<h1>Ingresar los tados de actualizacion del Conductor</h1>
		<form action="UpdateConductorServlet" method="post">
			<table border="1">
				<tr>
					<th colspan="2">Datos del conductor</th>
				</tr>
				<tr>
					<td>Ingrese la cedula del conductor que desea modificar</td>
					<td>
